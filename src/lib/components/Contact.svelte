		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
			<div>
				<form onsubmit={handleSubmit} class="space-y-6">
					<div>
						<label for="name" class="block text-sm font-medium mb-2 text-foreground">
						...
						<input
							...
							bind:value={name}
							required
							class="w-full px-4 py-2 border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-primary bg-background text-foreground"
			...
			<div class="flex flex-col justify-center">
				<div class="bg-card rounded-lg p-8 shadow-lg border border-border">
					...
					<div class="space-y-4">
						<div class="flex items-center">
							...
							<span class="text-foreground">contact@techsolutions.com</span>
						</div>
						...
						<div class="flex items-center">
							...
							<span class="text-foreground">+62 812 3456 7890</span>
						</div>
					</div>
				</div>
			</div>
