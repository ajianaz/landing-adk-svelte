...
<section id="how-it-works" class="py-20 bg-gray-50 dark:bg-gray-800">
	<div class="container px-4 md:px-6">
		...
		<div class="relative">
			<!-- Progress line -->
			<div class="absolute left-1/2 top-12 transform -translate-x-1/2 h-[calc(100%-3rem)] w-1 bg-blue-200 dark:bg-gray-700 hidden md:block"></div>

			<div class="grid grid-cols-1 md:grid-cols-5 gap-8">
				{#each steps as step}
					<div class="relative flex flex-col items-center text-center md:text-left md:flex-row md:space-x-4 md:space-y-0">
						<!-- Step number circle -->
						<div class="flex-shrink-0 w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold z-10">
							{step.icon}
						</div>
